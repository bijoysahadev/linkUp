      ...
      <div className='bg-[#5F35F5] w-[82%] h-[92%]   rounded-[20px] flex flex-col items-center justify-between py-10'  >
        ...
        <div  className=''   >
          <ul className='flex flex-col gap-y-10 '   >
            <li onClick={handleList} className={`text-5xl   relative  after:absolute after:left-[67px] after:top-1/2  after:w-[160px] after:h-16  ${active ? "after:bg-[white]": "after:bg-transparent"} after:content-[""]  after:rounded-l-md ${active ? "text-[#5F35F5] ": "text-white"} after:-translate-1/2   before:absolute before:top-1/2 before:-translate-y-1/2  before:-right-25 ${active ? "before:bg-[#5F35F5]" : "bg-transparent"} before:w-[10px] before:h-16 before:content-[""]  before:rounded-l-xl  before:z-19`} >  <IoHomeOutline  className='relative top-0 left-0 z-10'   /></li>


            <li onClick={handleList} className={`text-5xl   relative  after:absolute after:left-[67px] after:top-1/2  after:w-[160px] after:h-16  ${active ? " after:bg-[white]" :"after:bg-transparent"}  after:content-[""]  after:rounded-l-md ${active ? "text-[#5F35F5] ": "text-white"} after:-translate-1/2   before:absolute before:top-1/2 before:-translate-y-1/2  before:-right-25  ${active ? "before:bg-[#5F35F5] " :"before:bg-transparent"} before:w-[10px] before:h-16 before:content-[""]  before:rounded-l-xl  before:z-19`} >  <LuMessageCircleMore  className='relative top-0 left-0 z-10' /></li>
